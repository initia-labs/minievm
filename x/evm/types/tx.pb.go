...
type MsgCreate2 struct {
	...
	Salt cosmossdk_io_math.Int `protobuf:"bytes,3,opt,name=salt,proto3,customtype=cosmossdk.io/math.Int" json:"salt"`
	// Value is the amount of fee denom token to transfer to the contract.
...
type MsgCall struct {
	...
	AuthList []SetCodeAuthorization `protobuf:"bytes,6,rep,name=auth_list,json=authList,proto3" json:"auth_list"`
}
...
func (m *MsgCall) GetAuthList() []SetCodeAuthorization {
	if m != nil {
		return m.AuthList
	}
	return nil
...
var fileDescriptor_d925564029372f6a = []byte{
	...
	,
}

...
type Params struct {
	...
	// gas_enforcement defines the gas enforcement for evm transactions
	// If it is null, no gas enforcement exist
...
type GasEnforcement struct {
	// max_gas_fee_cap defines the maximum gas price of one evm message (base fee + gas tip < max_gas_fee_cap).
	// If the max gas price is "", there is no limit of gas price
	MaxGasFeeCap string `protobuf:"bytes,1,opt,name=max_gas_fee_cap,json=maxGasFeeCap,proto3" json:"max_gas_fee_cap,omitempty" yaml:"max_gas_fee_cap"`
	// max_gas defines the maximum gas_limit of one evm message.
	// If the max gas is "", there is no limit of gas
	...
	// unlimited_gas_senders defines the list of addresses that have no gas limits
...
var fileDescriptor_98c9eab1c4bf0154 = []byte{
	...
	,
}
...
func (this *GasEnforcement) Equal(that interface{}) bool {
	...
	if this.MaxGasFeeCap != that1.MaxGasFeeCap {
		return false
	}
...
func (m *GasEnforcement) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.MaxGasFeeCap) > 0 {
		...
		i = encodeVarintTypes(dAtA, i, uint64(len(m.MaxGasFeeCap)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil

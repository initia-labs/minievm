...
type Params struct {
	...
	// max_gas_fee_cap defines the maximum gas price of one transaction (base fee + gas tip < max_gas_fee_cap).
	// If the max gas price is "", there is no limit of gas price
	MaxGasFeeCap string `protobuf:"bytes,8,opt,name=max_gas_fee_cap,json=maxGasFeeCap,proto3" json:"max_gas_fee_cap,omitempty" yaml:"max_gas_fee_cap"`
	// max_gas defines the maximum gas_limit of one transaction.
	// If the max gas is "", there is no limit of gas
	MaxGasLimit uint64 `protobuf:"varint,9,opt,name=max_gas_limit,json=maxGasLimit,proto3" json:"max_gas_limit,omitempty" yaml:"max_gas_limit"`
}
...
var fileDescriptor_98c9eab1c4bf0154 = []byte{
	...
	,
}

...
type GasEnforcement struct {
	...
	// If set to an empty string, no gas price cap is enforced.
	MaxGasFeeCap *cosmossdk_io_math.Int `protobuf:"bytes,1,opt,name=max_gas_fee_cap,json=maxGasFeeCap,proto3,customtype=cosmossdk.io/math.Int" json:"max_gas_fee_cap,omitempty" yaml:"max_gas_fee_cap"`
...
var fileDescriptor_98c9eab1c4bf0154 = []byte{
	...
	,
}
...
func (this *GasEnforcement) Equal(that interface{}) bool {
	...
	if that1.MaxGasFeeCap == nil {
		if this.MaxGasFeeCap != nil {
			return false
		}
	} else if !this.MaxGasFeeCap.Equal(*that1.MaxGasFeeCap) {
		return false
	}

...
var (
	...
	fd_GenesisState_connect_oracle   protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_GenesisState_connect_oracle = md_GenesisState.Fields().ByName("connect_oracle")
}
...
func (x *fastReflection_GenesisState) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if len(x.ConnectOracle) != 0 {
		value := protoreflect.ValueOfBytes(x.ConnectOracle)
		if !f(fd_GenesisState_connect_oracle, value) {
			return
		}
	}
}
...
func (x *fastReflection_GenesisState) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "minievm.evm.v1.GenesisState.connect_oracle":
		return len(x.ConnectOracle) != 0
	default:
		if fd.IsExtension() {
...
func (x *fastReflection_GenesisState) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "minievm.evm.v1.GenesisState.connect_oracle":
		panic(fmt.Errorf("field connect_oracle of message minievm.evm.v1.GenesisState is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: minievm.evm.v1.GenesisState"))
		}
...
func (x *fastReflection_GenesisState) ProtoMethods() *protoiface.Methods {
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if len(x.ConnectOracle) > 0 {
			i -= len(x.ConnectOracle)
			copy(dAtA[i:], x.ConnectOracle)
			i = runtime.EncodeVarint(dAtA, i, uint64(len(x.ConnectOracle)))
			i--
			dAtA[i] = 0x52
		}
		if len(x.Erc20Wrapper) > 0 {
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 10:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field ConnectOracle", wireType)
				}
				var byteLen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				x.ConnectOracle = append(x.ConnectOracle[:0], dAtA[iNdEx:postIndex]...)
				if x.ConnectOracle == nil {
					x.ConnectOracle = []byte{}
				}
				iNdEx = postIndex
			default:
				iNdEx = preIndex
...
func (x *GenesisState) GetConnectOracle() []byte {
	if x != nil {
		return x.ConnectOracle
	}
	return nil
}
...
var file_minievm_evm_v1_genesis_proto_rawDesc = []byte{
	...
	0x22, 0xf2, 0x05, 0x0a, 0x0c, 0x47, 0x65, 0x6e, 0x65, 0x73, 0x69, 0x73, 0x53, 0x74, 0x61, 0x74,
	...
	0x52, 0x0c, 0x65, 0x72, 0x63, 0x32, 0x30, 0x57, 0x72, 0x61, 0x70, 0x70, 0x65, 0x72, 0x12, 0x25,
	0x0a, 0x0e, 0x63, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x5f, 0x6f, 0x72, 0x61, 0x63, 0x6c, 0x65,
	0x18, 0x0a, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x0d, 0x63, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x4f,
	0x72, 0x61, 0x63, 0x6c, 0x65, 0x22, 0x39, 0x0a, 0x0f, 0x47, 0x65, 0x6e, 0x65, 0x73, 0x69, 0x73,
	...
	,
	...
	0x63, 0x74, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x12, 0x10, 0x0a, 0x03, 0x75, 0x72, 0x69,
	0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x75, 0x72, 0x69, 0x22, 0x41, 0x0a, 0x13, 0x47,
	0x65, 0x6e, 0x65, 0x73, 0x69, 0x73, 0x45, 0x56, 0x4d, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x48, 0x61,
	...
	0x18, 0x02, 0x20, 0x01, 0x28, 0x04, 0x52, 0x06, 0x68, 0x65, 0x69, 0x67, 0x68, 0x74, 0x42, 0xa3,
	0x01, 0x0a, 0x12, 0x63, 0x6f, 0x6d, 0x2e, 0x6d, 0x69, 0x6e, 0x69, 0x65, 0x76, 0x6d, 0x2e, 0x65,
	0x76, 0x6d, 0x2e, 0x76, 0x31, 0x42, 0x0c, 0x47, 0x65, 0x6e, 0x65, 0x73, 0x69, 0x73, 0x50, 0x72,

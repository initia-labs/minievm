...
generate_swagger "${ROOT_DIR}/proto" minievm
...
swagger-combine ./client/docs/config-minievm.json -o ./client/docs/swagger-ui/swagger-minievm.yaml -f yaml --continueOnConflictingPaths true --includeDefinitions true

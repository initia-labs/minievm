...
require (
	...
	github.com/initia-labs/kvindexer/submodules/evm-tx v0.3.0
...
replace (
	...
	github.com/ethereum/go-ethereum => github.com/initia-labs/evm v0.0.0-20250617075707-0b38f068dce0
